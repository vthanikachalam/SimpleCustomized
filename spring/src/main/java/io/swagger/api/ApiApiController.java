...
public class ApiApiController implements ApiApi {
    ...
    public ResponseEntity<Contact> addContactUsingPOST(@ApiParam(value = "contact" ,required=true )  @Valid @RequestBody Contact contact) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
                return new ResponseEntity<Contact>(objectMapper.readValue("", Contact.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<List<Contact>> getAllContactsUsingGET() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
                return new ResponseEntity<List<Contact>>(objectMapper.readValue("", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type ", e);
